...
struct WithAttachments<Content: View>: View {
  ...
  @State private var model = AttachmentResolutionModel()
...
// The model is not nested in the generic view: a main-actor class inside it would carry the
// view's `Content: View` conformance, which Swift 6.2 reports as possibly isolated.
@MainActor @Observable final class AttachmentResolutionModel {
